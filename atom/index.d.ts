...
export declare const AC: AtomCoreConstructor;
/** Функция-контейнер*/
...
/** @internal */
export declare type MaybeAny<T> = unknown extends T ? any : T;
/**
...
declare type ValueReceiver<T extends any> = (v: T) => void;
/** Экземпляр атома
 * @remarks
 * Функция-контейнер.
 */
export interface Atom<T> {
    ...
    (value?: T): T;
    /** Доставить значение всем дочерним слушателям и установить новое значение в контейнер.*/
    (value?: T, ...auxiliaryValues: any[]): void;
    /**
     * Вернуть текущее значение контейнера
     */
    (): Promise<T> | T;
