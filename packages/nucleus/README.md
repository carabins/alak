...
> Проактивный контейнер-функция для управления потоками данных

Nucleus (нуклон) — это функция-контейнер для проактивной доставки данных в функции-получатели. Это базовый примитив библиотеки Alak, аналог Observable/Signal.
...
- **Проактивность** — автоматическое обновление зависимых вычислений
