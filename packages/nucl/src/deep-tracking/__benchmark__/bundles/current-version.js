...
//#region packages/nucl/src/deep-tracking/utils.ts
/**
* Получает путь к свойству от текущего узла до корня
*/
...
/**
* Находит корневой узел в иерархии
*/
...
//#endregion
//#region packages/nucl/src/deep-tracking/constants.ts
...
//#endregion
//#region packages/nucl/src/deep-tracking/handler.ts
const PARENT = "__parent__";
const IS_PROXY = "__isProxy__";
const RAW = "__raw__";
const reactiveMap$1 = /* @__PURE__ */ new WeakMap();
const rawMap$1 = /* @__PURE__ */ new WeakMap();
/**
* Создает инструментацию для методов массива (как во Vue)
*/
function createArrayInstrumentations(options) {
	...
	for (const method of ITERATION_ARRAY_METHODS) {
		const original = Array.prototype[method];
		instrumentations[method] = function(...args) {
...
/**
* Создает обработчик для Proxy, реализующий глубокую реактивность
*/
function createReactiveHandler(options) {
	...
	return {
		get(parent, key, receiver) {
			...
			if (key === RAW) return parent.value;
			const target = parent.value;
			...
			let proxy = reactiveMap$1.get(value);
			...
			if (!proxy) {
				...
				reactiveMap$1.set(value, proxy);
				rawMap$1.set(proxy, value);
			}
			return proxy;
		},
...
//#endregion
//#region packages/nucl/src/deep-tracking/tracker.ts
const reactiveMap = /* @__PURE__ */ new WeakMap();
const rawMap = /* @__PURE__ */ new WeakMap();
/**
* Создает трекер для глубокой реактивности объектов
*/
