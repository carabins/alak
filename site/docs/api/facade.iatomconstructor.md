...
|  [holistic()](./facade.iatomconstructor.md#holistic-method) | Создать атом, с аргументами передающимися в функции-добытчики в полном числе. [IAtom.stateless()](./facade.iatom.md#stateless-method). |
