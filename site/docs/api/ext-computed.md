...
|  --- | --- |
|  [installComputedExtension()](./ext-computed.md#installcomputedextension-function) | Установить расширение вычисления множеств прокси-атома |
