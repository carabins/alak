...
|  [holistic(bool)](./facade.iatom.md#holistic-method) | Сделать конетейнер принимающим и передаюшим множество агрументов. Все аргументы переданные в атом, сохраняются как массив. В функции-получатели значения передаются в полном количестве. |
