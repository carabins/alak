...
const DEFAULT_FORMATS = ['global'];
export async function browser(project) {
    ...
    const buildOptions = typeof rawBuildOptions === 'object' && rawBuildOptions !== null && !Array.isArray(rawBuildOptions)
        ? rawBuildOptions
        : {};
