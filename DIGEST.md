...
- [CHECK.md](CHECK.md) — процедура верификации (§2 покрывает plugin-logi/idb/tauri с 2026-04-20).
- [packages/alaq/DESIGN.md](packages/alaq/DESIGN.md) — философия alaq seed.
